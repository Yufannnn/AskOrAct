...
def main():
    ...
    copy_plan = [
        ...
        ("results/setup_overview.png", "figures/setup_overview.png"),
        ("results/ask_or_act_pipeline.png", "figures/ask_or_act_pipeline.png"),
        ...
        ("CS6208_Project/final_report.pdf", "report/final_report.pdf"),
        ("CS6208_Project/progress_report.pdf", "report/progress_report.pdf"),
        ...
        ("CS6208_Project/presentation_slides.tex", "presentation/presentation_slides.tex"),
        ("CS6208_Project/presentation_slides.pdf", "presentation/presentation_slides.pdf"),
