...
ABLATION_CSV_PATH = "results/metrics/metrics_ablations.csv"
ROBUST_ANSWER_CSV_PATH = "results/metrics/metrics_robust_answer_noise.csv"
ROBUST_MISMATCH_CSV_PATH = "results/metrics/metrics_robust_mismatch.csv"
GENERALIZATION_TEMPLATES_CSV_PATH = "results/metrics/metrics_generalization_templates.csv"
SCALEK_CSV_PATH = "results/metrics/metrics_scaleK.csv"
REPORT_MD = "results/reports/full_report.md"
...
def main():
    ...
    plot_setup_overview("results/figures/paper/setup_overview.png")
    plot_ask_or_act_pipeline("results/figures/paper/ask_or_act_pipeline.png")
    plot_main_dashboard(CSV_PATH, "results/figures/paper/main_dashboard.png")
    plot_clarification_quality_entropy_delta(CSV_PATH, "results/figures/exploratory/clarification_quality_entropy_delta.png")
    plot_pareto_k4(CSV_PATH, "results/figures/exploratory/pareto_K4.png")
    if os.path.exists(ABLATION_CSV_PATH):
        plot_ablations_dashboard(ABLATION_CSV_PATH, "results/figures/exploratory/ablations_dashboard.png")
    if os.path.exists(ROBUST_ANSWER_CSV_PATH):
        plot_robust_answer_noise_deltas(ROBUST_ANSWER_CSV_PATH, "results/figures/exploratory/robust_answer_noise_deltas.png")
    if os.path.exists(ROBUST_MISMATCH_CSV_PATH):
        plot_robust_mismatch_deltas(ROBUST_MISMATCH_CSV_PATH, "results/figures/exploratory/robust_mismatch_deltas.png")
    if os.path.exists(GENERALIZATION_TEMPLATES_CSV_PATH):
        from src.eval.plots import plot_generalization_templates
        plot_generalization_templates(GENERALIZATION_TEMPLATES_CSV_PATH, "results/figures/exploratory/generalization_templates_plot.png")
    if os.path.exists(SCALEK_CSV_PATH):
        from src.eval.plots import plot_scale_k
        plot_scale_k(SCALEK_CSV_PATH, "results/figures/exploratory/scaleK_plot.png")
